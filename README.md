<div align="center">
  ...
  <p>
    ...
    &nbsp;
    <a href="https://github.com/oumoeurtmm-code/ai-terminal-workflow">
      <img src="https://img.shields.io/badge/Main_Repo-ai--terminal--workflow-FF9900?style=flat&logo=amazon-aws&logoColor=white"/>
    </a>
    &nbsp;
    <a href="https://linkedin.com/in/ommousa">
      <img src="https://img.shields.io/badge/LinkedIn-ommousa-0A66C2?style=flat&logo=linkedin&logoColor=white"/>
    </a>
  </p>
</div>
...
|---|---|
| **Cloud** | AWS · Azure · GCP |
| **FinOps** | AWS Cost Explorer · AWS Budgets · Savings Plans · Cost Allocation Tagging |
| **Identity & Access** | Okta · Active Directory · Azure AD · SSO · SCIM · Duo MFA |
| **Endpoint Management** | JAMF · Puppet · SCCM |
| **Automation** | Python · PowerShell · Bash · n8n |
| **AI Tooling** | Claude Code · Gemini · Grok · Perplexity |
| **Security** | SentinelOne EDR · Cisco VPN · Malwarebytes · SIEM |
| **DevOps** | Docker · Git · Terraform · Linux · Windows · macOS |
| **ITSM** | JIRA · Confluence · Remedy |
...
FinOps                ████████████████████  Cost Optimization · FinOps Lifecycle
IT Automation         ████████████████░░░░  n8n · Python · PowerShell
Security & IAM        ███████████████░░░░░  Zero-trust · Okta · EDR
```

---

**All projects, labs, and live docs → [oumoeurtmm-code.github.io](https://oumoeurtmm-code.github.io)**
